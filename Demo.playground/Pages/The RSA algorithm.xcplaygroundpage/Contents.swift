...
func generatePrime(ofWidth width: Int) -> Number {
    while true {
...
//: We know their product isn't prime, and `Number`'s primality test agrees:
let n = p * q
n.isPrime()
...
let secret: Number = Number("Arbitrary precision arithmetic is fun!".data(using: .utf8)!)
